...
SECRET_KEY = 'fe#j@9h_bqxhg@+=a$r*2m(ayr*np@-02qak_w75b8#2bk3t1#'
...
TEMPLATES = [
    {
        ...
        # lyh 
        # 'DIRS': [],  # static 和 templates 放在app下
        'DIRS': [os.path.join(BASE_DIR,  'templates'), ],  # templates 放在根目录下
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# 是在部署静态文件时(pyhtonmanage.pycollectstatic)所有的静态文静聚合的目录
